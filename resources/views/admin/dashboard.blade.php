...
<div class="bg-white shadow-lg rounded-xl p-4 md:p-8 min-h-[calc(100vh-6rem)]"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            {{-- Gunakan x-text untuk update otomatis --}}
            <p class="text-3xl font-extrabold text-gray-900 mt-2" x-text="stats.ordersInProgress">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p class="text-3xl font-extrabold text-gray-900 mt-2" x-text="stats.pendingPayments">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p class="text-3xl font-extrabold text-gray-900 mt-2" x-text="stats.nearDeadline">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p class="text-3xl font-extrabold text-gray-900 mt-2" x-text="stats.ordersRevisi">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p class="text-3xl font-extrabold text-gray-900 mt-2" x-text="stats.totalDesignTypes">
